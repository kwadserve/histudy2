    ...
    <div class="rbt-overlay-page-wrapper">
        ...
        <div class="rbt-blog-details-area rbt-section-gapBottom breadcrumb-style-max-width">
            <div class="row">
                    ...
                    <div class="blog-content-wrapper rbt-article-content-wrapper">
                        <div class="content">
                            <div class="post-thumbnail mb--30 position-relative wp-block-image alignwide">
                                <figure>
                                    <img src="{{ $data->kapak != null ? url('assets' . $data->kapak) : url('/assets/images/blog/blog-single-03.png') }}"
                                        alt="Blog Images">
                                </figure>
                            </div>
                                        ...
                                        <li>
                                            <div class="thumbnail">
                                                <a href="{{route('front.blog.detail',$item->id)}}">
                                                    <img src="{{ $item->kapak != null ? url('assets' . $item->kapak) : url('assets/images/event/grid-type-04.jpg') }}"
                                                        alt="Academy">
                                                </a>
                                            </div>
                                            <div class="content">
                                                <h6 class="title"><a
                                                        href="{{route('front.blog.detail',$item->id)}}">{{ $item->title }}</a>
                                                </h6>
                                                <ul class="rbt-meta">
                ...
                <div class="blog-content-wrapper rbt-article-content-wrapper" style="margin-left:6px">
                        ...
                        <div class="rbt-comment-area">
                            ...
                            <ul class="comment-list">
                                        ...
                                        <div class="comment-body">
                                            <div class="single-comment">
                                                <div class="comment-img">
                                                    <img src="{{ $item->kisi->photo != null ? url('assets' . $item->kisi->photo) : url('assets/images/person_image.png') }}"
                                                        alt="Author Images">
                                                </div>
                                                <div class="comment-inner">
                                                    <h6 class="commenter">
                                                        <a href="#">{{ $item->kisi->name }}
                                                            {{ $item->kisi->surname }}</a>
                                                    </h6>
                                ...
                                @if (!Auth::guard('ogrenci')->check())
                                    <center>
                                        <div class="center">
                                            <span>Yorum yapmak için </span> <a href="{{ route('front.login') }}"> giriş
                                                yap!</a>
                                        </div>
                                    </center>
                                @endif
                        ...
                        @foreach ($uc as $item)
                            ...
                            <div class="rbt-card card-list variation-02 rbt-hover mt--30">
                                <div class="rbt-card-img">
                                    <a href="{{ route('front.blog.detail', $item->id) }}">
                                        <img src="{{ $item->kapak != null ? url('assets' . $item->kapak) : url('assets/images/blog/blog-card-02.jpg') }}"
                                            alt="Card image"> </a>
                                </div>
                                <div class="rbt-card-body">
                                    ...
                                    <div class="rbt-card-bottom">
                                        <a class="transparent-button" href="{{ route('front.blog.detail', $item->id) }}">
                                            İçerik<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg">
