    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="menu-title" data-key="t-apps">İŞLEMLER</li>


                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        <i data-feather="mail"></i>
                        <span data-key="t-email">ÖĞRETMEN</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('panel.teacher.add')}}" data-key="t-inbox">ÖĞRETMEN EKLE</a></li>
                        <li><a href="{{route('panel.teacher.list')}}" data-key="t-read-email">ÖĞRETMENLER</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        ...
                        <span data-key="t-ecommerce">KATEGORİ</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('panel.category.add')}}" key="t-products">KATEGORİ EKLE</a></li>
                        <li><a href="{{route('panel.category.list')}}" data-key="t-product-detail">KATEGORİLER</a></li>
                    </ul>
                </li>
